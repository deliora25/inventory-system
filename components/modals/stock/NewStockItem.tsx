...
import { CategoryType, ItemsType, StockItemType } from '@/types';
...
type Props = {
  fields: FieldArrayWithId<StockItemType, 'items', 'id'>[];
  append: UseFieldArrayAppend<StockItemType, 'items'>;
  register: UseFormRegister<StockItemType>;
  remove: UseFieldArrayRemove;
  items: ItemsType[];
};

function NewStockItem({ items, fields, append, register, remove }: Props) {
